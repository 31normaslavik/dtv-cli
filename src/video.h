...
int64_t release_year{}; // (numeric): Year (YYYY) when the video or album was released
...
double average_rating{}; // (numeric): Average rating give by users, the scale used depends on the webpage
